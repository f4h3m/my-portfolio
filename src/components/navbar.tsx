...
export default function Navbar() {
  return (
    <div className="bottom-0 z-30 fixed inset-x-0 flex mx-auto mb-4 h-full max-h-14 origin-bottom pointer-events-none">
      ...
      <Dock className="z-50 relative flex items-center bg-background mx-auto px-1 h-full min-h-full transform-gpu pointer-events-auto [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
        <BorderBeam
          size={90}
          duration={12}
          delay={9}
